export type Sections = [
  ...
  },
  {
    ...
    description: "Please provide your educational information to complete your profile.";
    formInputs: [
      {
        id: 18;
        label: "Student ID";
  ...
  },
  {
    ...
    description: "Record 60 seconds self-introduction video presentation and post it on YouTube.";
    formInput: [
      {
        id: 23;
        inputType: "textfield";
